...
export class Atm extends PureComponent {
    renderScreen = () => {
...
Atm.propTypes = {
  ...
  keyPadInput: PropTypes.number.isRequired,
  accountBalance: PropTypes.number.isRequired,
  atmInternalState: PropTypes.oneOf(ATM_STATES).isRequired,
};
